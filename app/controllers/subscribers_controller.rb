class SubscribersController < ApplicationController
  ...
  def edit
    @subscriber = Subscriber.find_by_auth_token(params[:id])
  end
  ...
  def create
    ...
    respond_to do |format|
      if @subscriber.save
        format.html { redirect_to subscriber_path(@subscriber.auth_token), notice: t('activerecord.notices.subscriber.create') }
